...
//        LeagueManager premierLeagueManager = PremierLeagueManagerService.getInstance();
//
//        // before testing we add data into the Txt file using the @Before annotation
//        PremierLeagueManagerService.loadingData();   // load all the data first
...
//            seasonList = PremierLeagueManagerService.seasonFilteredFootballCLubList("2020-21");
//
...
//        }
//        // testing
//        assertEquals(PremierLeagueManagerService.getPremierLeagueFootballClubList().size(),seasonList.size());
//
//    }
//
//    @Test
...
//        ArrayList<FootballClub> sortClubsByPoints = PremierLeagueUtil.sortClubsByPoints(PremierLeagueManagerService.
...
//        if (PremierLeagueManagerService.getPremierLeagueFootballClubList() != null) {
//            PremierLeagueManagerService.getPremierLeagueFootballClubList().sort(comparatorPoints);
//        }
//
//        // testing
//        assertEquals(PremierLeagueManagerService.getPremierLeagueFootballClubList(),sortClubsByPoints);
//
//    }
//
//    @Test
...
//                PremierLeagueManagerService.getPremierLeagueFootballClubList());
//
...
//        if (PremierLeagueManagerService.getPremierLeagueFootballClubList() != null) {
//            PremierLeagueManagerService.getPremierLeagueFootballClubList().sort(comparatorByWins);
//        }
//
//        // testing
//        assertEquals(PremierLeagueManagerService.getPremierLeagueFootballClubList(),sortClubsByWins);
//
//    }
//
//    @Test
...
//        // check is the club list is not empty and then only sorts
//        if (PremierLeagueManagerService.getPremierLeagueFootballClubList() != null) {
//            PremierLeagueManagerService.getPremierLeagueFootballClubList().sort(comparatorByGoals);
//        }
//
//        // testing
//        assertEquals(PremierLeagueManagerService.getPremierLeagueFootballClubList(),sortClubsByGoals);
//    }
//
//    @Test
...
//
//        // testing
//        assertEquals(expectedSeasons,PremierLeagueManagerService.getAllSeasonAdded());
//    }
//
//    @Test
...
//                getMatchesForSeason(PremierLeagueManagerService.getPremierLeagueFootballClubList());
//
//        // getting the expected list of matches
//        ArrayList<Match> expectedMatches = new ArrayList<>();
//        for (FootballClub club: PremierLeagueManagerService.getPremierLeagueFootballClubList()) {
...
//                    PremierLeagueManagerService.getPremierLeagueFootballClubList(), "2020-12-14"
//            );
//
//        } catch (CloneNotSupportedException e) {
