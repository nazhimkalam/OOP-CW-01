...
public class PremierLeagueManager implements LeagueManager {
    ...
    public static String loadingData() {
        ...
        // text file path
        File file = new File("../GUI/public/resources/objectDataFile.txt");
      ...
      if(lengthOfClubNameTable != 0){
          ...
          for (int index = 0; index < seasonFilteredClubs.size(); index++) {
              ...
              */
              ...
              System.out.println("|    "+organisedResultList.get(0)+ "    |   "+ seasonFilteredClubs.get(index)
                      .getName()
    ...
    public String clearDataFile() {
        ...
        */
        ...
        try {
            file = new FileWriter("../GUI/public/resources/objectDataFile.txt");
