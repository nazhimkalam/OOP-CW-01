...
public class FootballClub implements Serializable {
    ...
    public FootballClub(String name, String location, ClubStats clubStatistics, String coachName,
                        int totalGoalsReceived, int totalGoalsScored, int totalGoalsDifference,
    ...
    public String toString() {
        return  "name='" + name + ", location='" + location + ", clubStatistics=" + clubStatistics +
                ", coachName='" + coachName + ", totalGoalsReceived=" + totalGoalsReceived +
                ", totalGoalsScored=" + totalGoalsScored + ", totalGoalsDifference=" + totalGoalsDifference +
                ", totalYellowCards=" + totalYellowCards + ", totalRedCards=" + totalRedCards +
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, location, clubStatistics, coachName, totalGoalsReceived, totalGoalsScored,
                totalGoalsDifference, totalYellowCards, totalRedCards, matchesPlayed);
    }
